...
sealed class Screen(val route: String) {
    ...
    object Editor : Screen("editor/{noteId}") {
        fun createRoute(noteId: Long?) = "editor/${noteId ?: -1L}"
    }
    object Labels : Screen("labels")
}

private fun NavHostController.openEditor(noteId: Long?) {
    navigate(Screen.Editor.createRoute(noteId)) {
    ...
    NavHost(
        ...
        composable(
            ...
            MainScreen(
                ...
                onNoteClick = { noteId -> navController.openEditor(noteId) },
                onEditLabels = { navController.navigate(Screen.Labels.route) },
                windowSizeClass = windowSizeClass,
        ...
        composable(
            ...
            enterTransition = { editorEnterTransition() },
            exitTransition = { fadeOut() },
            popEnterTransition = { fadeIn() },
            popExitTransition = { editorPopExitTransition() },
        ) {

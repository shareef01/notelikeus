...
**Git:** Phases 0–12 and Pages staging are on `main` (#145–#147). Kotlin debug staging wiring landed in #149. Open follow-ups: #148 (Pages/RPC; still conflicts), #150 (backup attachments; rebased, CI green), #151 (list thumbnails; rebased, ready; firestore-rules timed out).

...
export function ToastHost() {
  ...
  return (
    <div
      className={`fixed bottom-6 left-1/2 z-[70] flex max-w-[min(24rem,calc(100vw-2rem))] -translate-x-1/2 items-center gap-3 rounded-note px-4 py-3 text-sm font-medium shadow-lg pb-safe animate-in fade-in slide-in-from-bottom-4 duration-200 lg:bottom-8 ${
        message.tone === 'error'

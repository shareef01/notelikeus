...
class NoteAppFunctionsTest {
    ...
    private val context: AppFunctionContext = mockk()

    @Before
    fun setup() {
        repository = mockk(relaxed = true)
        reminderScheduler = mockk(relaxed = true)
        noteAppFunctions = NoteAppFunctions(repository, reminderScheduler)
    }
    ...
    fun `addReminder updates note and schedules reminder`() = runTest {
        ...
        coVerify { reminderScheduler.scheduleReminder(1L, futureTime) }
    }
